...
const sectorTestimonials = [
  {
    ...
    src: "/avatars_sample/avatar1.avif",
  },
  {
    name: "Marketing",
    ...
    src: "/avatars_sample/avatar2.avif",
  },
  {
    ...
    src: "/avatars_sample/avatar3.avif",
  },
  {
    ...
    src: "/avatars_sample/avatar4.avif",
  },
  {
    name: "Healthcare",
    ...
    src: "/avatars_sample/avatar5.jpg",
  },
]
...
export default function Home() {
  ...
  <LandingAccordionItem />
      ...
      <AboutSection />
      <GuideSection />
      <section id="sectors" className="bg-[#F3F4F4] py-16 lg:py-24">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-10 max-w-3xl">
            ...
            <p className="mt-4 text-base leading-8 text-[#1D546D]">
              Explore a few ways teams can use avatar-led communication across education, marketing,
              support, training, and healthcare.
            </p>
          </div>

          <div className="rounded-[32px] bg-[#F3F4F4]">
