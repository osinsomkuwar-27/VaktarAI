...
start "Avatar SadTalker :8004" cmd /k "cd /d D:\Coding\aiavatar\avatar_video && cd SadTalker && ..\venv\Scripts\python.exe -m uvicorn main:app --reload --host 0.0.0.0 --port 8004"
